...
# 2. box width: see Stat4Econ\style.css for body width, set width to bodywidth - 225
if (knitr::is_latex_output()) {
...
if(!is.null(spt_file_current)) {
  ...
  total_area <- (800 * 7) / 2
  if (st_file_wno_suffix == 'Introductory-Statistics-with-R-tidyverse') {
