---
title: An R Markdown document converted from "C:/Users/fan/Stat4Econ/probability/countrules.ipynb"
...
To figure out what the probabilities associted with different experimental outcomes are, we need to first know what possible experimental outcomes exist in the sample space.


## Trivial Counting

Often, we do not need to employ additional mathmatical tools, and can count directly  the number of experimental outcomes in a sample space.
